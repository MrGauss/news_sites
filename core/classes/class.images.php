<?php
	...
	class images
	{
		...
		static public final function _upload_process($file, $config)
		{
            ...
            {
                self::err('' . __CLASS__ . '::' . __METHOD__ . ' >> FILE "'.$file['filename'].'" not exist!');
            }
		...
		static private final function ins2db($data)
		{
			...
			$_2db['user_id'] = defined('NEWS_PARSER_USER_ID')?NEWS_PARSER_USER_ID:CURRENT_USER_ID;
