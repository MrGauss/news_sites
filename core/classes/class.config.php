...
{
    define( 'CONFIG_FILE', CORE_DIR.DS.'config.php' );
}
...
class config
{
	...
	static public final function get()
	{
		...
		if( file_exists( dirname(CONFIG_FILE).DS.DOMAIN.'-'.basename(CONFIG_FILE) ) ){ return require( dirname(CONFIG_FILE).DS.DOMAIN.'-'.basename(CONFIG_FILE) ); }
