var uploader = new function()
{
    this.dialog = function()
    {
		...
		console.log( 'Get upload dialog form' );
        ...
        $.ajax({ data: post }).done( function( _r )
        {
			...
			console.log( 'Upload dialog initialized!' );
    ...
    this.submit = function()
    {
        ...
        $('#upload_frame form').submit(function( event )
        {
			...
			console.log( 'Make submit fake forms' );
            $.ajax({
            ...
            }).done(function( _r )
            {
				...
				console.log( 'Uploading is ready!' );
